...
namespace trivago
{
    public partial class ChangeReservation : Form
    {
        ...
        private void room_cmb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            c.CommandText = "select RESERVID from reservation Where CUSTOMERID = :d ";
        ...
        private void delete_buttun_Click(object sender, EventArgs e)
        {
            if (roomnum != "")
            {
                ...
                else if (n == 1)
                {
                    ...
                    if (r != -1)
                    {
                        manage_app.customer_balance = manage_app.customer_balance + Convert.ToInt32(total_cost_txt.Text);
